...
export class ReportComponent implements OnInit {
  ...
  absCreditInfo = {};
  ratingGrades = ['AAA+', 'AAA', 'AAA-', 'AA+', 'AA', 'AA-', 'A+', 'A', 'A-', 'BBB+', 'BBB', 'BBB-', 'BB', 'BB+', 'BB-', 'B+', 'B', 'B-', 'C+', 'C', 'C-', 'D+', 'D', 'D-'];
  ...
  ngOnInit() {
    this.http.get('/assets/files/credit-rating.json').subscribe((data: any[]) => {
      this.list = data;
    ...
    this.http.get('/assets/files/credit-rating-detailed.json').subscribe((data: any[]) => {
