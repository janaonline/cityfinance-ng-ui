...
import { UlbadminServiceService } from 'src/app/pages/ulb-admin/ulbadmin-service.service';
...
import { EditComponent } from 'src/app/pages/stateforms/edit-ulb-profile//edit/edit.component';
...
@Component({
  selector: 'app-edit-ulb-table',
  templateUrl: './edit-ulb-table.component.html',
  styleUrls: ['./edit-ulb-table.component.scss']
})
export class EditUlbTableComponent extends BaseComponent implements OnInit {
