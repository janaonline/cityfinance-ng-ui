...
export class ReportHelperService {
  ...
  getBSSummaryCalcFields() {
    return [
      ...
      { keyName: 'totalLiability', title: 'Total Liabilities (A)', isCalc: true, addFields: ['310-312', '320', '330-331', '340-360', '300'] },
      ...
      { keyName: 'totalAssets', title: 'Total Assets (B)', isCalc: true, addFields: ['410-412', '420-421', '430-461', '470-480', '400'] },
    ];
  }
