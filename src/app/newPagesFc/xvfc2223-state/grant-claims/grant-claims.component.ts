...
gtcUrl_mpc = null;
  ...
  this.fetchData(this.years['2022-23']);
   ...
   //eligibiltiy objects
      ...
      this.grantClaimsService.getData2223(this.years['2022-23'], this.stateId).subscribe((response)=>{
  ...
  fetchData(financialYear) {
    this.grantClaimsService.getData2223(this.years['2022-23'], this.stateId).subscribe(
      (res) => {
        ...
        this.nmpcUntied_2_Data = data['nmpc_tied_2']
        ...
        this.currStatus_nmpc_untied_1st = this.nmpcUntied_1_Data?.nmpc_untied_2_GrantData['status']
