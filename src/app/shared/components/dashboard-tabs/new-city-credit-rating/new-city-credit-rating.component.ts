...
//   styleUrls: ['./new-city-credit-rating.component.css']
// })
// export class NewCityCreditRatingComponent implements OnInit {
...
export class NewCityCreditRatingComponent implements OnInit, OnDestroy {
  constructor(
  ...
  ngOnInit() {
    ...
    console.log("absCreditInfo", this.absCreditInfo);
