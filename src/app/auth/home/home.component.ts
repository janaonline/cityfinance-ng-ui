...
export class HomeComponent implements OnInit {
  ...
  importantLinks: Link[] = [
    ...
    {text: 'Municipal Bonds and Pooled Debt Obligations', link: '/credit-rating/municipal-bond'},
    {text: 'Credit Rating of all ULBs to date', link: '/credit-rating/report'},
    {text: 'Database of finance related provisions', link: '/dashboard/financial-information'},
