...
export const MODULES: { [key in MODULES_NAME]: IModules } = {
  ...
  [MODULES_NAME.ULB_SIGNUP_REQUEST]: {
    ...
    access: {
      [ACTIONS.VIEW]: [USER_TYPE.STATE, USER_TYPE.PARTNER, USER_TYPE.ADMIN],
      [ACTIONS.APPROVE]: [USER_TYPE.STATE, USER_TYPE.PARTNER, USER_TYPE.ADMIN],
      [ACTIONS.REJECT]: [USER_TYPE.STATE, USER_TYPE.PARTNER, USER_TYPE.ADMIN]
    }
  },
  ...
  [MODULES_NAME.ULB_PROFILE]: {
    ...
    access: {
      ...
      [ACTIONS.APPROVE]: [USER_TYPE.STATE, USER_TYPE.PARTNER, USER_TYPE.ADMIN],
      [ACTIONS.REJECT]: [USER_TYPE.STATE, USER_TYPE.PARTNER, USER_TYPE.ADMIN],
      [ACTIONS.EDIT]: [USER_TYPE.ADMIN, USER_TYPE.PARTNER, USER_TYPE.ULB]
    }
  },
  ...
  [MODULES_NAME.STATE]: {
    ...
    access: {
      [ACTIONS.CREATE]: [USER_TYPE.PARTNER, USER_TYPE.ADMIN],
      [ACTIONS.VIEW]: [USER_TYPE.PARTNER, USER_TYPE.ADMIN],
      [ACTIONS.EDIT]: [USER_TYPE.PARTNER, USER_TYPE.ADMIN],
      [ACTIONS.DELETE]: [USER_TYPE.PARTNER, USER_TYPE.ADMIN]
    }
  }
};
